        ...
        <div className='bg-gray-100 min-h-screen py-6 md:py-8 lg:py-10 px-3 md:px-16 lg:px-20'>
            ...
            <div className='flex justify-center flex-col md:flex-row items-start gap-5'>
                <div className='w-full md:w-[40%] lg:w-[45%] bg-white rounded-sm p-4 shadow-md'>
                            ...
                            {profileLinks.map(link =>
                                <li key={link.id}>
                                    <button
                                        ...
                                        className={`${activeComponent === link.componentId ? 'bg-red-200 border text-red-950 border-gray-500' : ''} w-full flex items-center gap-3 py-2 px-3 rounded-sm`}
                                    >
                                        {link.icon}
                                        {link.title}
                                    </button>
                    ...
                    <div className='mt-6'>
                        <button onClick={handleSignOut} className='flex items-center gap-3 font-medium text-red-600 cursor-pointer text-[16px]'>
