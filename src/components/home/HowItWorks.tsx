        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mt-5 md:mt-8 lg:mt-10">
          {
            howItWorksData.map(step =>(
              <div key={step.id} className="bg-white p-3 md:p-4 lg:p-5 rounded-xl space-y-1 shadow-md">
                <p className="bg-gray-300 text-red-900 p-2 inline-block rounded-full">{step.icon && <step.icon />}</p>
